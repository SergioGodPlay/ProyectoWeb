...
SECRET_KEY = 'nt=b46m^*d*6)qh1p$%#z35$c9+rm$n37b9-f!3n20162m=h4*'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                #Agregamos la ruta donde se encuentra la funcion que se encarga de sumar el valor total del carro
